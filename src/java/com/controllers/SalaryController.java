...
public class SalaryController {
    ...
    public String salaryList(Model model, HttpServletRequest request, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            model.addAttribute("weekSalaryList", weekSalaryList != null ? weekSalaryList : new ArrayList<>());
        } catch (Exception e) {
            model.addAttribute("weekSalaryList", new ArrayList<>());
    ...
    public String salaryDetails(@RequestParam int weekScheduleID, Model model, HttpServletRequest request, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            model.addAttribute("salaryDetails", salaryDetails != null ? salaryDetails : new ArrayList<>());
            ...
            model.addAttribute("salaryDetails", new ArrayList<>());
            model.addAttribute("totalSalary", BigDecimal.ZERO);
            model.addAttribute("totalHours", 0);
    ...
    public void exportSalaryCSV(@RequestParam int weekScheduleID,
        ...
        try {
            ...
            if (salaryDetails == null) salaryDetails = new ArrayList<>();
            ...
            String fileName = "NestMart_Salary_Report_" + 
                    (weekSchedule != null ? sdf.format(weekSchedule.getWeekStartDate()) : "unknown") +
                    "_to_" + 
                    (weekSchedule != null ? sdf.format(weekSchedule.getWeekEndDate()) : "unknown") + 
                    ".csv";
            ...
            for (EmployeeSalaryDTO salary : salaryDetails) {
                writer.printf("%d,\"%s\",%.2f,%d,%.2f%n",
                        salary.getAccountID(),
                        salary.getFullName() != null ? salary.getFullName() : "Unknown",
