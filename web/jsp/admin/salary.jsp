                    ...
                    <div class="container mt-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <c:choose>
                                        <c:when test="${not empty weekSalaryList}">
                                            <c:forEach var="week" items="${weekSalaryList}">
                                                <tr>
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${not empty week.weekStartDate and not empty week.weekEndDate}">
                                                    ...
                                                    <td>${week.totalHoursWorked != null ? week.totalHoursWorked : 0}</td>
                                                    <td>
                                                        <c:choose>
                                                    ...
                                                    <td>
                                                        <form action="${pageContext.request.contextPath}/admin/salaryDetails.htm" method="GET" style="display: inline;">
