...
- **Database**: SQL Server (`mssql-jdbc-12.2.0.jre8.jar`)  
...
4. Configure JDBC (if using SQL Server):  
   ...
   - Or ensure `web/WEB-INF/jdbc.properties` contains correct DB connection info  
...
👉 [https://nestmart.publicvm.com/nestmartappFinal/client/clientboard.htm](https://nestmart.publicvm.com/nestmartappFinal/client/clientboard.htm)  
